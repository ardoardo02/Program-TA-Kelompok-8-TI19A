...
<head>
  ...
  <div class="container">
      ...
      <div class="row">
        <div class="col">
          <div class="form-group">
            <center>
              <h5><b>
                  <label for="exampleFormControlTextarea1">Huruf Latin</label>
            </center>
            </h5></b>
        ...
        <div class="col">
          <div class="form-group">
            <center>
              <h5><b>
                  <label for="exampleFormControlTextarea1">Aksara Jawa</label>
            </center>
            </h5></b>
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
          </div>
    ...
    <center>
      <button type="button" class="btn btn-info">Terjemahkan</button>
    </center>
